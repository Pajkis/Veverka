...
public class GameplayConfig : ScriptableObject
{
    ...
    [Tooltip("Duration for tile fade in effect")]
    public float tileFadeInDuration = 0.5f;
    [Tooltip("Duration for tile fade out effect")]
    public float tileFadeOutDuration = 0.5f;

    [Header("Effects")]
    [Tooltip("Speed factor for nuts pushed by splash (0.5 = half speed, 2.0 = double speed)")]
    public float splashSpeedFactor = 0.5f;
